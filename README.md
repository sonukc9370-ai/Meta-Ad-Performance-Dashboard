...
2.  **Download the Power BI Desktop file (`.pbix`) from the `PowerBI` folder here: [Meta Ad Performance Dashboard.pbix](https://github.com/sonukc9370-ai/Meta-Ad-Performance-Dashboard/blob/main/PowerBi/Meta%20Ad%20Performance%20Dashboard.pbix)**
